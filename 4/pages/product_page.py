...
class ProductPage(BasePage):
    ...
    def should_be_add_to_cart_btn(self):
        assert self.is_element_present(*ProductPageLocators.ADD_TO_CART_BUTTON) == True, "Add to cart button is not present"

    def should_not_be_success_message(self):
        assert self.is_not_element_present(*ProductPageLocators.SUCCESS_MESSAGE) == True, "Success message is present"

    def should_be_disappeared_message(self):
        assert self.is_disappeared(*ProductPageLocators.SUCCESS_MESSAGE) == True, "Success message has not disappeared"
    ...
    def check_name_product_added_to_cart(self):
        ...
        assert add_to_cart_message_name == self.get_product_name(), "Wrong product added to basket"
    ...
    def check_price_product_added_to_cart(self):
        ...
        assert self.get_product_price() == add_to_cart_message_price, "Wrong product price added to basket"